...
final class InterfaceLanguageSettings: ObservableObject {
    ...
    private static let zhHans: [String: String] = [
        ...
        "Untitled": "未命名",
        "Version": "版本",
        "A recording workspace for scripted screen videos.": "为视频录制打造的可爱风提词器APP",
        ...
        "Permission Required for Recording": "需要获取权限以进行视频录制",
        "The following permissions are needed for video recording:": "为正常使用视频录制功能，需要获取以下权限：",
        "Screen Recording: Capture screen content": "屏幕录制：捕获屏幕内容",
        "Microphone: Record audio": "麦克风：录制声音",
        "Camera: Record video": "相机：录制视频画面",
        "Requesting %@ permission…": "正在请求%@权限…",
        "Continue": "继续授权",
        "File Access": "文件访问",
        "Export Successful": "导出成功",
        "The video has been exported successfully.": "视频已成功导出。",
        "Base URL (optional)": "接口地址（可选）",
        "A cute teleprompter for video recording": "为视频录制打造的可爱风提词器",
        "Write your script": "撰写脚本",
        "Markdown editor with AI-powered breath cuts": "支持 Markdown 编辑，AI 智能断句",
        "Read from teleprompter": "提词器朗读",
        "Notch, floating, or fullscreen — your choice": "灵动岛、悬浮窗、全屏，随你选择",
        "Record with confidence": "自信录制",
        "One-click to record your video": "一键录制口播视频",
        "Theme": "主题配色",
        "Type your script here…": "请在这里输入口播稿",
        "chars": "字",
        "Get Started": "开始使用",
        "Get a free API key at": "免费获取 API Key：",
        "Switch front/back: Mac menu bar camera icon → choose camera": "切换前后置：Mac 菜单栏摄像头图标 → 选择摄像头",
        "Jump to page": "跳转页面",
